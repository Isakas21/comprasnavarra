...
import 'package:comprasnavarra/widgets/swiper_widget.dart';
...
class SelectScreen extends StatelessWidget {
  ...
  Widget _swiper() {
    return FutureBuilder(
      future: dataProvider.getListaNombres(box.read("zonas") ?? args['zonas'], box.read("tipos") ?? args['tipos'], box.read("localidad") ?? args['localidad']),
      initialData: [],
